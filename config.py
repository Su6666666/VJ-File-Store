...
SHORTLINK_API = environ.get("SHORTLINK_API", "cef037c9a767b7ff64d5424f04f02ec6885fbf71") # shortlink api
SHORTLINK_URL = environ.get("SHORTLINK_URL", "arlinks.in") # shortlink domain without https://
